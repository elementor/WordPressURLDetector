...
class SitemapParser
{
    ...
    public function parse( $url, $url_content = null )
    {
        ...
        if (! $this->urlValidate($this->current_url)) {
            throw new \WordPressURLDetector\WordPressURLDetectorException('Invalid URL');
        }
    ...
    protected function getContent()
    {
        ...
        try {
            ...
            throw new \WordPressURLDetector\WordPressURLDetectorException('Unable to fetch URL contents', 0, $e);
        } catch (\WordPressURLDetectorGuzzleHttp\Exception\GuzzleException $e) {
            throw new \WordPressURLDetector\WordPressURLDetectorException('WordPressURLDetectorGuzzleHttp exception', 0, $e);
        }
    }
     ...
     * @param array<mixed> $array Tag array
     * @return bool
     */
     ...
     *
     * @param array<mixed> $tags Tags check if exists
